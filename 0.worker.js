...
/******/ 	return __webpack_require__(__webpack_require__.s = "xs5M");
/******/ })
/************************************************************************/
/******/ ({
...
/*!******************************************************************************************!*\
  ...
  \******************************************************************************************/
/*! exports provided: CSV_CONTENT_TYPE, CSV_DEFAULT_CONFIG, CSV_DIMENSION_ERROR_TYPE_ENUM, CSV_PARSE_ERROR_COLUMNS, CsvErrorContainer, CsvFile, ErrorCodes, HEADER_ERROR_COLUMNS, ROW_ERROR_COLUMNS, RowError, readCSV, save, validateHeaders, writeCSV, ɵ0 */
/***/ (function(module, __webpack_exports__, __webpack_require__) {

"use strict";
__webpack_require__.r(__webpack_exports__);
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "CSV_CONTENT_TYPE", function() { return CSV_CONTENT_TYPE; });
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "CSV_DEFAULT_CONFIG", function() { return CSV_DEFAULT_CONFIG; });
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "CSV_DIMENSION_ERROR_TYPE_ENUM", function() { return CSV_DIMENSION_ERROR_TYPE_ENUM; });
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "CSV_PARSE_ERROR_COLUMNS", function() { return CSV_PARSE_ERROR_COLUMNS; });
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "CsvErrorContainer", function() { return CsvErrorContainer; });
...
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "HEADER_ERROR_COLUMNS", function() { return HEADER_ERROR_COLUMNS; });
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "ROW_ERROR_COLUMNS", function() { return ROW_ERROR_COLUMNS; });
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "RowError", function() { return RowError; });
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "readCSV", function() { return readCSV; });
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "save", function() { return save; });
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "validateHeaders", function() { return validateHeaders; });
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "writeCSV", function() { return writeCSV; });
...
const HEADER_ERROR_COLUMNS = ['EXPECTED_HEADER', 'ACTUAL_HEADER', 'COLUMN'];
const ROW_ERROR_COLUMNS = ['ROW', 'COLUMN', 'VALUE', 'MESSAGE'];
class RowError {
    constructor(ROW, COLUMN, VALUE, MESSAGE) {
        this.ROW = ROW;
        this.COLUMN = COLUMN;
        this.VALUE = VALUE;
...
/**
 * Consider making this dynamic and passing it with
 * state changes.
 */
const CSV_PARSE_ERROR_COLUMNS = ['CODE', 'ROW', 'INDEX', 'MESSAGE'];
/**
 * Enum for tables containing dimension data.
 */
var CSV_DIMENSION_ERROR_TYPE_ENUM;
(function (CSV_DIMENSION_ERROR_TYPE_ENUM) {
    CSV_DIMENSION_ERROR_TYPE_ENUM[CSV_DIMENSION_ERROR_TYPE_ENUM["PARSER_ERROR"] = 0] = "PARSER_ERROR";
    CSV_DIMENSION_ERROR_TYPE_ENUM[CSV_DIMENSION_ERROR_TYPE_ENUM["HEADER_ERROR"] = 1] = "HEADER_ERROR";
    CSV_DIMENSION_ERROR_TYPE_ENUM[CSV_DIMENSION_ERROR_TYPE_ENUM["DUPLICATES_ERROR"] = 2] = "DUPLICATES_ERROR";
    CSV_DIMENSION_ERROR_TYPE_ENUM[CSV_DIMENSION_ERROR_TYPE_ENUM["DIMENSION_ERROR"] = 3] = "DIMENSION_ERROR";
    CSV_DIMENSION_ERROR_TYPE_ENUM[CSV_DIMENSION_ERROR_TYPE_ENUM["REFERENTIAL_INTEGRITY_ERROR"] = 4] = "REFERENTIAL_INTEGRITY_ERROR";
    CSV_DIMENSION_ERROR_TYPE_ENUM[CSV_DIMENSION_ERROR_TYPE_ENUM["DATA_ERROR"] = 5] = "DATA_ERROR";
})(CSV_DIMENSION_ERROR_TYPE_ENUM || (CSV_DIMENSION_ERROR_TYPE_ENUM = {}));
/**
 * Note that the columns are included
 * in case we want to display the errors
 * in a table and emit the errors
 * and columns on the same instance.
 */
class CsvErrorContainer {
    constructor(CSV_DIMENSION_ERROR_TYPE, errors = [], columns = [], pageSizeDefault = 5, pageSizeOptions = [5, 10, 15, 20]) {
        this.CSV_DIMENSION_ERROR_TYPE = CSV_DIMENSION_ERROR_TYPE;
        this.errors = errors;
...
const CSV_CONTENT_TYPE = "text/plain;charset=utf-8";
function save(fileName, entities) {
    //==============================
    // Create the CSV String
    //===============================
    const csv = writeCSV(entities);
 ...
 */
function writeCSV(entities, config = CSV_DEFAULT_CONFIG) {
...
console.log(result);
 ...
 ```
 */
function readCSV(csv, config = CSV_DEFAULT_CONFIG) {
...
/**
 * Have it return an array of
 * this return some type of HeaderError instances.
 * Utility method for verifying CSV records headers.
 *
 * @param headers The headers expected on the Purchase Order CSV Record
 */
function validateHeaders(result, targetHeaders) {
    const errors = [];
    result.meta.fields.forEach((header, i) => {
        if (targetHeaders[i] != header.trim()) {
            errors.push({
                EXPECTED_HEADER: targetHeaders[i],
                ACTUAL_HEADER: header.trim(),
                COLUMN: i
            });
        }
    });
...
/***/ "xs5M":
/*!*******************************************************************************************************************************************************************!*\
  !*** ./node_modules/@angular-devkit/build-angular/src/babel/webpack-loader.js??ref--7-0!./node_modules/@ngtools/webpack/src/ivy!./src/app/services/csv.worker.ts ***!
  \*******************************************************************************************************************************************************************/
/*! no exports provided */
/***/ (function(module, __webpack_exports__, __webpack_require__) {
...
addEventListener('message', ({ data }) => {
    const result = Object(_fireflysemantics_csv__WEBPACK_IMPORTED_MODULE_0__["readCSV"])(data);
    postMessage(result);
});
